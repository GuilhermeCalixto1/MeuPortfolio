...
export default function LineWaves({
  ...
  useEffect(() => {
    ...
    // FIX 1: Inicializar explicitamente como nulo e usar tuplas para os mouses
    ...
    function resize() {
      ...
      // FIX 2: Verificação rigorosa para evitar erro de inicialização
    ...
    function update(time: number) {
      ...
      if (enableMouseInteraction) {
        ...
        // Acesso seguro ao array uMouse.value
