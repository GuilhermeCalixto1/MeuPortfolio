...
if (typeof document !== "undefined" && !document.getElementById(KEYFRAMES_ID)) {
  ...
  100% { background-position: 100% 50%, 100% 50%, center; }
}

@keyframes pc-electric-flicker {
  0%, 100% { opacity: 0.8; filter: brightness(1.2) saturate(1.2); }
  50% { opacity: 1; filter: brightness(2) saturate(2) drop-shadow(0 0 15px rgba(114, 227, 255, 0.8)); }
}
    @keyframes pc-code-trail {
      0% { transform: translate3d(0, 0, 0) rotate(var(--trail-rot, -10deg)); opacity: 1; }
      94% { opacity: 1; }
      100% { transform: translate3d(var(--trail-distance, 980px), 0, 0) rotate(var(--trail-rot, -10deg)); opacity: 0; }
    }
  `;
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const iconTrailLayerStyle: React.CSSProperties = {
    position: "absolute",
    inset: 0,
    zIndex: 6,
    pointerEvents: "none",
  ...
  const iconTrails = [
    { top: "10%", size: "72px", duration: "7.6s", delay: "0s", rot: "-10deg" },
    {
      top: "28%",
      size: "56px",
      duration: "6.8s",
      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            {/* Code icon trails */}
            <div style={iconTrailLayerStyle}>
              {iconTrails.map((trail, index) => (
                <div
                  key={`code-trail-${index}`}
                  className="absolute"
                  style={{
                    left: "-120px",
                    top: trail.top,
                    width: trail.size,
                    height: trail.size,
                    animation: `pc-code-trail ${trail.duration} linear infinite, pc-electric-flicker 480ms steps(2, end) infinite`,
                    animationDelay: `${trail.delay}, ${trail.delay}`,
                    ["--trail-rot" as string]: trail.rot,
                    ["--trail-distance" as string]: "1200px",
                    position: "absolute",
                ...
                >
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, rgba(198,247,255,0.98) 0%, rgba(113,214,255,0.98) 45%, rgba(188,126,255,0.95) 100%)",
                      ...
                      filter: "drop-shadow(0 0 12px rgba(113, 214, 255, 0.55))",
                    }}
                  />
                  <img
                    src={iconUrl}
                    ...
                    style={{
                      opacity: 0.35,
                      filter: "drop-shadow(0 0 8px rgba(113, 214, 255, 0.65))",
                      mixBlendMode: "screen",
                    }}
                  />
                </div>
            ...
            >
              <img
                ...
                loading="lazy"
                style={{
                  // Garante que a imagem escala a partir do centro
                  transformOrigin: "center center",
                  transform: `
